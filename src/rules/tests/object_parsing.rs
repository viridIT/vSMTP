...
mod test {
    ...
    use crate::rules::tests::init::run_engine_test;

    #[tokio::test]
    async fn test_object_parsing_count() {
        async fn test() {
            assert_eq!(
    ...
    #[tokio::test]
    async fn test_object_parsing_ip4() {
        async fn test() {
    ...
    #[tokio::test]
    async fn test_object_parsing_fqdn() {
        async fn test() {
            let engine = rule_engine::acquire_engine();
    ...
    #[tokio::test]
    async fn test_object_parsing_val() {
        async fn test() {
            let engine = rule_engine::acquire_engine();
    ...
    #[tokio::test]
    async fn test_object_parsing_addr() {
        async fn test() {
            let engine = rule_engine::acquire_engine();
    ...
    #[tokio::test]
    async fn test_object_parsing_file() {
        async fn test() {
            let engine = rule_engine::acquire_engine();
    ...
    #[tokio::test]
    async fn test_object_parsing_regex() {
        async fn test() {
            let engine = rule_engine::acquire_engine();
    ...
    #[tokio::test]
    async fn test_object_parsing_groups() {
        async fn test() {
            let engine = rule_engine::acquire_engine();
                            ...
                            match &authorized_users[..] {
                                [Object::File(whitelist), Object::Ip4(authorized_ip)] => {
                                    match &whitelist[..] {
                                        ...
                                        _ => {
                                            panic!("failed, objects tested aren't of type 'addr'.")
                                        }
                                    };
