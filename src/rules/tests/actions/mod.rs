...
fn test_logs() {
    ...
    let re = RuleEngine::new(&Some("./src/rules/tests/actions/logs".into()))
...
fn test_users() {
    ...
    let re = RuleEngine::new(&Some("./src/rules/tests/actions/users".into()))
        .expect("couldn't build rule engine");
    let mut state = get_default_state();
...
fn test_send_mail() {
    ...
    let re = RuleEngine::new(&Some("./src/rules/tests/actions/send_mail".into()))
        .expect("couldn't build rule engine");
    let mut state = get_default_state();
